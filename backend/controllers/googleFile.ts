...
class GoogleFileController {
  ...
  getMongoGoogleList = async (req: RequestTypeFullUser, res: Response) => {
    ...
    try {
      ...
      const mongoGoogleFiles = await googleFileService.getMongoGoogleList(
        user,
        query,
      );
      ...
      console.log(
        '\nGet Google/Mongo List Error Google File Route:',
        e.message,
      );
      const code = !e.code
        ? 500
  ...
  getFileInfo = async (req: RequestTypeFullUser, res: Response) => {
    console.log('get google mongo list1');
    if (!req.user) {
      return;
    }

    console.log('get google mongo list');
  ...
  getGoogleMongoQuickList = async (req: RequestTypeFullUser, res: Response) => {
    ...
    try {
      ...
      const googleMongoQuickList = await googleFileService.getGoogleMongoQuickList(
        user,
      );
  ...
  getGoogleMongoSuggestedList = async (
    ...
    try {
      ...
      const fileAndFolderList = await googleFileService.getGoogleMongoSuggestedList(
        user,
        searchQuery,
      );
      ...
      console.log(
        '\nGet Google/Mongo Suggested List Error Google File Route:',
        e.message,
      );
      const code = !e.code
        ? 500
