...
class SettingsPageContainer extends React.Component {
  ...
  refreshStorageSize = () => {
    axios
      .patch("/user-service/refresh-storage-size", undefined)
      .then((response) => {
        this.getUserDetails();
      })
      .catch((err) => {
  ...
  submitAddName = (e) => {
    ...
    axios
      .patch("/user-service/add-name", data)
      .then((response) => {
                            ...
                            <span>
                              {!this.state.loaded
                                ...
                                : env.commercialMode &&
                                  this.state.userDetails.activeSubscription
                                ? `${bytes(
                                    this.state.userDetails.storageData
                                      .storageSize
                                  )} of 
                  ${bytes(
                    this.state.userDetails.storageData.storageLimit
                    ...
                    <div className="elem__control--settings">
                      <div className="control__title">
                        <div className="double__title">
                          ...
                          <span>
                            {!this.state.loaded
                              ? "Loading..."
                              : this.state.userDetails.googleDriveEnabled
                              ? this.state.userDetails.googleDriveData.id
                              : "No Google Account"}
                          </span>
                        </div>
                      </div>
                      <div className="control__value">
                        <div className="available__space--wrap">
                            ...
                            <div
                              ...
                              style={{
                                ...
                                width: !this.state.loaded
                                  ? "0%"
                                  : this.state.userDetails.googleDriveEnabled
                                  ? `${this.getStoragePercentageGoogle()}%`
                                  : "0%",
                              }}
                            ></div>
                          </div>
                          <span>
                            {this.state.userDetails.googleDriveEnabled
                              ? !this.state.userDetails.storageDataGoogle.failed
                                ? `${bytes(
                                    this.state.userDetails.storageDataGoogle
                                      .storageSize
                                  )} of 
                  ${bytes(
                    this.state.userDetails.storageDataGoogle.storageLimit
                ...
                >
                  ...
                  >
                    <input
                      ...
                      onChange={this.onChangeGoogleID}
                      placeholder="Drive Client ID"
                    />
                  </div>
                  <div
                    className="group__password"
                  ...
                  >
                    <input
                      value={this.state.googleSecret}
                      onChange={this.onChangeGoogleSecret}
                      type="password"
